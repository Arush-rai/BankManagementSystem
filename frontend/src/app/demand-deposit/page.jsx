...
const DemandDeposit = () => {
    ...
    const demandForm = useFormik({
        ...
        onSubmit: (values) => {
            ...
            axios.post('http://localhost:5000/demand/add', values)
                .then((response) => {
                    console.log(response.status);
                    toast.success('Your demand Deposit has been added');
                }).catch((err) => {
                    console.log(err);
            ...
            <>
                ...
                <div className="max-w-4xl mt-28 m-12 px-4 py-10 sm:px-6 lg:px-8 mx-auto">
                    ...
                    <div className="bg-white rounded-xl shadow shadow-gray-700 p-4 sm:p-7">
                        <div className="mb-8">
                            <h2 className="text-4xl text-center font-bold text-gray-500">Demand Deposit</h2>

                        </div>
                        <form onSubmit={demandForm.handleSubmit}>
                            {/* Grid */}
                            <div className="grid sm:grid-cols-12 gap-2 sm:gap-6">
                                ...
                                <div className="sm:col-span-9">
                                    <div className="sm:flex">
                                        <input
                                            ...
                                            id='number'
                                            onChange={demandForm.handleChange}
                                            value={demandForm.values.number}
                                ...
                                <div className="sm:col-span-9">
                                    <textarea
                                        ...
                                        id='current_Address'
                                        onChange={demandForm.handleChange}
                                        value={demandForm.values.current_Address}
                                ...
                                <div className="sm:col-span-9">
                                    <textarea
                                        ...
                                        onChange={demandForm.handleChange}
                                        value={demandForm.values.permanent_Address}
                                        className="py-2 px-3 block w-full border-2 border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                        rows={3}
                                ...
                                <div className="sm:col-span-9">
                                    <input
                                        ...
                                        id='acc_number'
                                        onChange={demandForm.handleChange}
                                        value={demandForm.values.acc_number}
                                        className="py-2 px-3 pe-11 block w-full border-2 border-gray-300 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                ...
                                <div className="sm:col-span-9">
                                    <input
                                        ...
                                        id='aadhar'
                                        onChange={demandForm.handleChange}
                                        value={demandForm.values.aadhar}
                                        className="py-2 px-3 pe-11 block w-full border-2 border-gray-300 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                        placeholder="xxxx-xxxx-xxxx"
                                        required
                                    />
                                ...
                                <div className="sm:col-span-9">
                                    <input
                                        ...
                                        id='tenure'
                                        onChange={demandForm.handleChange}
                                        value={demandForm.values.tenure}
                                        className="py-2 px-3 pe-11 block w-full border-2 border-gray-300 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                ...
                                <div className="sm:col-span-9">
                                    <input
                                        ...
                                        id='branch'
                                        onChange={demandForm.handleChange}
                                        value={demandForm.values.branch}
                                        className="py-2 px-3 pe-11 block w-full border-2 border-gray-300 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                                        required
