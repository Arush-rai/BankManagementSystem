...
const recover_passvord = () => {
  return (
    ...
    <div className='max-w-sm ml-auto pt-28 pb-20'>
      <div className="mt-28 bg-gray-200 border border-gray-200 rounded-xl shadow-sm">
...
export default recover_passvord
